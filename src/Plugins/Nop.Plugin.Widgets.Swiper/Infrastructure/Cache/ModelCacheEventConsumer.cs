...
namespace Nop.Plugin.Widgets.Swiper.Infrastructure.Cache
{
        ...
        IConsumer<EntityDeletedEvent<Setting>>
    {
        ...
        /// </remarks>
        public static CacheKey PICTURE_URL_MODEL_KEY = new("Nop.plugins.widgets.swiper.pictureurl-{0}-{1}", PICTURE_URL_PATTERN_KEY);
        public const string PICTURE_URL_PATTERN_KEY = "Nop.plugins.widgets.swiper";
